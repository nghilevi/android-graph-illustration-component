...
public class TruitonAChartEngineActivity extends Activity {
    ...
    private void myChartSettings(XYMultipleSeriesRenderer renderer) {
        renderer.setChartTitle("Performance by AChartEngine BarChart");
        renderer.setXAxisMin(0.5);
        renderer.setXAxisMax(10.5);
        renderer.setYAxisMin(0);
        renderer.setYAxisMax(210);
        renderer.addXTextLabel(1, "2011");
        renderer.addXTextLabel(2, "2012");
        renderer.addXTextLabel(3, "2013");
        renderer.addXTextLabel(4, "2014");
